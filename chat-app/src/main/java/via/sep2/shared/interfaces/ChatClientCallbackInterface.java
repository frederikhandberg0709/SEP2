...
public interface ChatClientCallbackInterface extends Remote {
    ...
    void onUserJoinedGroup(int roomId, UserDTO user, String invitedBy) throws RemoteException;

    void onUserLeftGroup(int roomId, UserDTO user, boolean wasRemoved, String removedBy) throws RemoteException;

    // Admin notifications
    void onPromotedToAdmin(int roomId, UserDTO user, String promotedBy) throws RemoteException;

    void onDemotedFromAdmin(int roomId, UserDTO user, String demotedBy) throws RemoteException;
